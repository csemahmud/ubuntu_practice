 ...
 * 
 */
package IO19FindByTXTAppPackage.classes;
...
public class FindByTXT extends SimpleFileVisitor<Path> {
	...
	public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
		...
		try(SeekableByteChannel sbchannel = Files.newByteChannel(file)){
			...
			// Read the bytes with the proper encoding in this platform. If
			// you skip this step, you might see something looks like
